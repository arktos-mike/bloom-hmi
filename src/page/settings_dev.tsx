    ...
    <div className='wrapper'>
      <Row gutter={[8, 8]} style={{ flex: '1 1 100%', alignSelf: 'stretch', alignItems: 'stretch', display: 'flex' }}>
        <Col span={12} style={{ display: 'flex', alignItems: 'stretch', alignSelf: 'stretch' }}>
          <Card title={t('panel.com')} extra={<Segmented onResize={undefined} onResizeCapture={undefined} size='middle' value={com} onChange={(value) => { setCom(value.toString()); }} options={[{ label: 'COM1', value: 'opCOM1', icon: <ApiOutlined />, },
